...
int main(void)
{
    FILE *fin = fopen("/home/jinatina815/project_0309/part6/scoreProcess/score.dat", "r");
    FILE *fout = fopen("/home/jinatina815/project_0309/part6/scoreProcess/score.out", "w");
    int n;
